...
slides <- c("Basic/slides/index.Rmd", "ETL/slide1/index.Rmd", "ETL/slide2/index.Rmd", "Visualization/slide1/index.Rmd", "Visualization//slide2/lecture_ggplot2/index.Rmd", "Visualization/slide3/index.Rmd")
